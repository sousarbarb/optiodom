...
Method.results.beta  = ( Method.results.uncalibrated.cw.cgX - Method.results.uncalibrated.ccw.cgX ) / ( -4*L );
Method.results.alpha = ( Method.results.uncalibrated.cw.cgX + Method.results.uncalibrated.ccw.cgX ) / ( -4*L );
% - curvature radius:
Method.results.R = (L/2)/sin(Method.results.beta/2);
% - systematic errors:
Method.results.Eb = (pi/2)/(pi/2 - Method.results.alpha);
